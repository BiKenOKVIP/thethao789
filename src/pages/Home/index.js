...
function formatDate(timestamp) {
    ...
    if (date.toDateString() === currentDate.toDateString()) {
        ...
        date.toDateString() === new Date(currentDate - oneDay).toDateString()
    ) {
        return 'Hôm qua';
    } else if (
        date.toDateString() === new Date(currentDate + oneDay).toDateString()
...
function Home() {
    ...
    useEffect(() => {
        fetch(
            'https://api.thethao789.com/api/post/getByTagSlug/bong-da?pageIndex=1&pageSize=6',
        )
            .then((res) => res.json())
            .then((posts) => {
                setPosts(posts.data);
        ...
        <div className={cx('wrapper')}>
            ...
            <div className={cx('content')}>
                ...
                <div className={cx('post')}>
                    <TitleNews>Tin mới nhất sdgfa </TitleNews>
